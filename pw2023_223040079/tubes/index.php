...
<!-- About Section Start -->
<section id="about" class="about" style="background-color: rgba(235, 127, 127, 0.8);">
  <h2>About Us</h2>
...
<div class=" daftar">
  <?php foreach ($makanan as $makan) : ?>
    <div class="menu-card">
      <ul>
        <li class="gambar"><img src="img/<?= $makan["gambar"]; ?>"></li>
        <a href="#recipe">
          <li class="namautama"> <?= $makan["nama"] ?>
        </a>
        <!-- <li> Bahan : <?= $makan["bahan"] ?></li> -->
        <!-- <li> Cara Membuat : <?= $makan["cara membuat"] ?></li> -->
      </ul>
    </div>
  <?php endforeach; ?>
  </div>
